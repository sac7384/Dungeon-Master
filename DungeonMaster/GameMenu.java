  ...
  public void tyrnel(){
    while (true){
      ...
      if (x==2){
        ...
        else if (p.getQuestProgress(4)==1){
          System.out.println("Parlin: Wondering where to look for the thieves? I would try the Shadow Forest. It's past the Plain Plains, take the north fork on the west side.");
        }
