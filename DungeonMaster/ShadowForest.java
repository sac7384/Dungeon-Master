...
public class ShadowForest {
  ...
  public void eastSide() {
    while (true) {
      System.out.println("Shadow Forest - East Side\n-------------------------");
      System.out.println("0-Return to Tyrnel\n1-Player Menu\n2-Single Fight\n3-Journey through the forest (W)\n4-Enter the Plain Plains (E)");
      int x=scan.nextInt();
  ...
  public void westSide() {
    while (true) {
      System.out.println("Shadow Forest - West Side\n-------------------------");
      System.out.println("0-Return to Tyrnel\n1-Player Menu\n2-Single Fight\n3-Journey through the forest (E)");
      int x=scan.nextInt();
  ...
  public void single(){
    ...
    if (g==5){
      ...
      MysteriousCave cave=new MysteriousCave(p);
      if (p.getQuestProgress(4)==1){
        ...
        System.out.println("We already explored the dungeon in there but if you wanna go back in we can. Might find so cool loot or something");
        System.out.println("Enter 1 if you wanna go in or anything else if you want to keep on doing what we're doing");
        int v=scan.nextInt();
        if (v==1) {
          System.out.println("Alright, guess we're going in");
          cave.enter();
        }
        else {
